...
namespace kaikosdk {
PROTOBUF_CONSTEXPR StreamAggregatesSpotExchangeRateV2RequestV1::StreamAggregatesSpotExchangeRateV2RequestV1(
...
struct StreamAggregatesSpotExchangeRateV2RequestV1DefaultTypeInternal {
  ...
  ~StreamAggregatesSpotExchangeRateV2RequestV1DefaultTypeInternal() {}
  union {
    StreamAggregatesSpotExchangeRateV2RequestV1 _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 StreamAggregatesSpotExchangeRateV2RequestV1DefaultTypeInternal _StreamAggregatesSpotExchangeRateV2RequestV1_default_instance_;
}  // namespace kaikosdk
static ::_pb::Metadata file_level_metadata_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto = nullptr;

const uint32_t TableStruct_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::kaikosdk::StreamAggregatesSpotExchangeRateV2RequestV1, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::kaikosdk::StreamAggregatesSpotExchangeRateV2RequestV1, _impl_.assets_),
...
static const ::_pb::Message* const file_default_instances[] = {
  &::kaikosdk::_StreamAggregatesSpotExchangeRateV2RequestV1_default_instance_._instance,
};

const char descriptor_table_protodef_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
const ::_pbi::DescriptorTable descriptor_table_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto = {
    ...
    file_level_metadata_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto, file_level_enum_descriptors_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto,
    file_level_service_descriptors_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto_getter() {
  return &descriptor_table_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto(&descriptor_table_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto);
namespace kaikosdk {

// ===================================================================

class StreamAggregatesSpotExchangeRateV2RequestV1::_Internal {
 public:
...
StreamAggregatesSpotExchangeRateV2RequestV1::_Internal::assets(const StreamAggregatesSpotExchangeRateV2RequestV1* msg) {
...
void StreamAggregatesSpotExchangeRateV2RequestV1::clear_window() {
...
StreamAggregatesSpotExchangeRateV2RequestV1::StreamAggregatesSpotExchangeRateV2RequestV1(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:kaikosdk.StreamAggregatesSpotExchangeRateV2RequestV1)
}
StreamAggregatesSpotExchangeRateV2RequestV1::StreamAggregatesSpotExchangeRateV2RequestV1(const StreamAggregatesSpotExchangeRateV2RequestV1& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  StreamAggregatesSpotExchangeRateV2RequestV1* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
inline void StreamAggregatesSpotExchangeRateV2RequestV1::SharedCtor(
...
StreamAggregatesSpotExchangeRateV2RequestV1::~StreamAggregatesSpotExchangeRateV2RequestV1() {
  // @@protoc_insertion_point(destructor:kaikosdk.StreamAggregatesSpotExchangeRateV2RequestV1)
...
inline void StreamAggregatesSpotExchangeRateV2RequestV1::SharedDtor() {
...
void StreamAggregatesSpotExchangeRateV2RequestV1::Clear() {
// @@protoc_insertion_point(message_clear_start:kaikosdk.StreamAggregatesSpotExchangeRateV2RequestV1)
...
const char* StreamAggregatesSpotExchangeRateV2RequestV1::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          do {
            ...
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "kaikosdk.StreamAggregatesSpotExchangeRateV2RequestV1.include_exchanges"));
...
uint8_t* StreamAggregatesSpotExchangeRateV2RequestV1::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:kaikosdk.StreamAggregatesSpotExchangeRateV2RequestV1)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  for (int i = 0, n = this->_internal_include_exchanges_size(); i < n; i++) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "kaikosdk.StreamAggregatesSpotExchangeRateV2RequestV1.include_exchanges");
  ...
  for (int i = 0, n = this->_internal_exclude_exchanges_size(); i < n; i++) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      s.data(), static_cast<int>(s.length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "kaikosdk.StreamAggregatesSpotExchangeRateV2RequestV1.exclude_exchanges");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:kaikosdk.StreamAggregatesSpotExchangeRateV2RequestV1)
  return target;
}

size_t StreamAggregatesSpotExchangeRateV2RequestV1::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:kaikosdk.StreamAggregatesSpotExchangeRateV2RequestV1)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData StreamAggregatesSpotExchangeRateV2RequestV1::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    StreamAggregatesSpotExchangeRateV2RequestV1::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*StreamAggregatesSpotExchangeRateV2RequestV1::GetClassData() const { return &_class_data_; }


void StreamAggregatesSpotExchangeRateV2RequestV1::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<StreamAggregatesSpotExchangeRateV2RequestV1*>(&to_msg);
  auto& from = static_cast<const StreamAggregatesSpotExchangeRateV2RequestV1&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:kaikosdk.StreamAggregatesSpotExchangeRateV2RequestV1)
...
void StreamAggregatesSpotExchangeRateV2RequestV1::CopyFrom(const StreamAggregatesSpotExchangeRateV2RequestV1& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:kaikosdk.StreamAggregatesSpotExchangeRateV2RequestV1)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool StreamAggregatesSpotExchangeRateV2RequestV1::IsInitialized() const {
  return true;
}

void StreamAggregatesSpotExchangeRateV2RequestV1::InternalSwap(StreamAggregatesSpotExchangeRateV2RequestV1* other) {
  using std::swap;
...
::PROTOBUF_NAMESPACE_ID::Metadata StreamAggregatesSpotExchangeRateV2RequestV1::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto_getter, &descriptor_table_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto_once,
      file_level_metadata_sdk_2fstream_2faggregates_5fspot_5fexchange_5frate_5fv2_2frequest_2eproto[0]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace kaikosdk
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::kaikosdk::StreamAggregatesSpotExchangeRateV2RequestV1*
Arena::CreateMaybeMessage< ::kaikosdk::StreamAggregatesSpotExchangeRateV2RequestV1 >(Arena* arena) {
  return Arena::CreateMessageInternal< ::kaikosdk::StreamAggregatesSpotExchangeRateV2RequestV1 >(arena);
}
